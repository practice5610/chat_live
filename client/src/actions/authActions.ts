...
export const registerUser = (credentials: RegisterArgs) => {
  return async (dispatch: Dispatch) => {
    ...
    if ("error" in response) {
      ...
      dispatch(
        showAlert(
          `Hi 👋 ${response.userDetails.username}. Welcome to TalkHouse. I'm name_1, the creator of TalkHouse. You have me a as a friend till you invite and add your other friends 😊.`
        )
      );
    }
  };
